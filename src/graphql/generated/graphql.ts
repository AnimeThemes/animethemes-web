...
export type AnimeSummaryCardAnimeFragment = { slug: string, year: number | null, season: AnimeSeason | null, seasonLocalized: string | null, formatLocalized: string | null, title: { romaji: string }, animethemes: Array<{ group: { name: string, slug: string } | null }>, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } } & { ' $fragmentName'?: 'AnimeSummaryCardAnimeFragment' };
...
export type ArtistSummaryCardArtistFragment = { slug: string, name: { main: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } } & { ' $fragmentName'?: 'ArtistSummaryCardArtistFragment' };
...
export type ThemeSummaryCardThemeFragment = (
  { type: ThemeType, sequence: number | null, group: { name: string, slug: string } | null, anime: { slug: string, title: { romaji: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }, song: (
    { performances: Array<{ alias: string | null, as: string | null, artist: { slug: string, name: { main: string } } }> }
...
export type VideoSummaryCardEntryFragment = (
  { id: number, animetheme: (
    { id: number, type: ThemeType, sequence: number | null, group: { name: string, slug: string } | null, anime: { slug: string, title: { romaji: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }, song: { ' $fragmentRefs'?: { 'SongTitleSongFragment': SongTitleSongFragment;'PerformancesSongFragment': PerformancesSongFragment } } | null }
...
export type StudioCoverImageStudioFragment = { images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> }, anime: { nodes: Array<{ title: { romaji: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }> } } & { ' $fragmentName'?: 'StudioCoverImageStudioFragment' };
...
export type SearchGlobalQuery = { search: { anime: Array<(
      ...
      { slug: string }
      & { ' $fragmentRefs'?: { 'ArtistSummaryCardArtistFragment': ArtistSummaryCardArtistFragment } }
    )>, series: Array<{ slug: string, title: { romaji: string } }>, studios: Array<{ slug: string, name: string }>, playlists: Array<(
      { id: string }
...
export type SearchSeriesQuery = { seriesPagination: { data: Array<{ slug: string, title: { romaji: string } }>, paginatorInfo: { hasMorePages: boolean } } };
...
export type PerformancesSongFragment = { performances: Array<{ alias: string | null, as: string | null, relevance: number, artist: { id: number, slug: string, name: { main: string } }, member: { slug: string, name: { main: string } } | null }> } & { ' $fragmentName'?: 'PerformancesSongFragment' };

export type PerformancesArtistFragment = { id: number } & { ' $fragmentName'?: 'PerformancesArtistFragment' };

export type SongTitleSongFragment = { title: { romaji: string | null } } & { ' $fragmentName'?: 'SongTitleSongFragment' };
...
export type VideoPlayerBarEntryFragment = { animetheme: { type: ThemeType, sequence: number | null, song: (
      ...
      & { ' $fragmentRefs'?: { 'SongTitleSongFragment': SongTitleSongFragment;'PerformancesSongFragment': PerformancesSongFragment } }
    ) | null, group: { name: string } | null, anime: { slug: string, title: { romaji: string } } } } & { ' $fragmentName'?: 'VideoPlayerBarEntryFragment' };
...
export type VideoPageAnimeFragment = (
  { slug: string, year: number | null, season: AnimeSeason | null, title: { romaji: string }, animethemes: Array<(
    { id: number, type: ThemeType, sequence: number | null, song: { title: { romaji: string | null }, performances: Array<{ as: string | null, relevance: number, artist: (
          { id: number }
          & { ' $fragmentRefs'?: { 'ArtistSummaryCardArtistFragment': ArtistSummaryCardArtistFragment } }
  ...
  )>, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> }, series: { nodes: Array<{ slug: string, title: { romaji: string } }> }, studios: { nodes: Array<(
      { slug: string }
      & { ' $fragmentRefs'?: { 'StudioSummaryCardStudioFragment': StudioSummaryCardStudioFragment } }
    )> } }
...
export type AnimeIndexPageQuery = { animePagination: { data: Array<{ slug: string, title: { romaji: string } }> } };
...
export type ArtistDetailPageArtistFragment = (
  { slug: string, name: { main: string }, synonyms: Array<{ text: string }>, performances: Array<{ alias: string | null, as: string | null, song: { id: number, title: { romaji: string | null }, performances: Array<{ alias: string | null, as: string | null, memberAlias: string | null, memberAs: string | null, artist: { slug: string, name: { main: string } } }>, animethemes: Array<(
        { id: number, type: ThemeType, sequence: number | null, animethemeentries: Array<{ videos: { nodes: Array<{ id: number }> } }>, group: { name: string, slug: string } | null, anime: { slug: string, year: number | null, season: AnimeSeason | null, title: { romaji: string } }, song: { title: { romaji: string | null } } | null }
        & { ' $fragmentRefs'?: { 'ThemeSummaryCardThemeFragment': ThemeSummaryCardThemeFragment;'ThemeSummaryCardThemeExpandableFragment': ThemeSummaryCardThemeExpandableFragment } }
      )> } }>, memberPerformances: Array<{ alias: string | null, as: string | null, memberAlias: string | null, memberAs: string | null, artist: { slug: string, name: { main: string } }, song: { id: number, title: { romaji: string | null }, performances: Array<{ alias: string | null, as: string | null, memberAlias: string | null, memberAs: string | null, artist: { slug: string, name: { main: string } } }>, animethemes: Array<(
        { id: number, type: ThemeType, sequence: number | null, animethemeentries: Array<{ videos: { nodes: Array<{ id: number }> } }>, group: { name: string, slug: string } | null, anime: { slug: string, year: number | null, season: AnimeSeason | null, title: { romaji: string } }, song: { title: { romaji: string | null } } | null }
        & { ' $fragmentRefs'?: { 'ThemeSummaryCardThemeFragment': ThemeSummaryCardThemeFragment;'ThemeSummaryCardThemeExpandableFragment': ThemeSummaryCardThemeExpandableFragment } }
      )> } }>, members: { edges: Array<{ alias: string | null, as: string | null, notes: string | null, relevance: number, node: (
        { slug: string, name: { main: string } }
        & { ' $fragmentRefs'?: { 'ArtistSummaryCardArtistFragment': ArtistSummaryCardArtistFragment } }
      ) }> }, groups: { edges: Array<{ alias: string | null, as: string | null, notes: string | null, node: { slug: string, name: { main: string } } }> }, images: { edges: Array<{ ' $fragmentRefs'?: { 'ExtractMultipleImagesImageArtistEdgeFragment': ExtractMultipleImagesImageArtistEdgeFragment } }> }, resources: { edges: Array<{ as: string | null, node: { link: string, site: ResourceSite, siteLocalized: string } }> } }
...
export type ArtistIndexPageQuery = { artistPagination: { data: Array<{ slug: string, name: { main: string } }> } };
...
export type AnimeAwardsPageThemeFragment = (
  { id: number, type: ThemeType, sequence: number | null, anime: { slug: string, title: { romaji: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }, song: { ' $fragmentRefs'?: { 'SongTitleWithArtistsSongFragment': SongTitleWithArtistsSongFragment } } | null }
  & { ' $fragmentRefs'?: { 'CreateVideoSlugThemeFragment': CreateVideoSlugThemeFragment } }
...
export type PlaylistDetailPageTrackFragment = { id: string, video: (
    ...
    { animetheme: { anime: { year: number | null, season: AnimeSeason | null, title: { romaji: string }, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }, song: { title: { romaji: string | null } } | null } }
...
export type SeriesDetailPageSeriesFragment = { slug: string, title: { romaji: string }, anime: { nodes: Array<(
      { slug: string, year: number | null, season: AnimeSeason | null, title: { romaji: string }, animethemes: Array<{ type: ThemeType, sequence: number | null, animethemeentries: Array<{ version: number, videos: { nodes: Array<{ tags: string | null }> } }> }>, images: { nodes: Array<{ ' $fragmentRefs'?: { 'ExtractImagesImageFragment': ExtractImagesImageFragment } }> } }
      & { ' $fragmentRefs'?: { 'AnimeSummaryCardAnimeFragment': AnimeSummaryCardAnimeFragment;'AnimeSummaryCardAnimeExpandableFragment': AnimeSummaryCardAnimeExpandableFragment } }
...
export type SeriesIndexPageQuery = { seriesPagination: { data: Array<{ slug: string, title: { romaji: string } }> } };

export type StudioDetailPageStudioFragment = (
  { slug: string, name: string, anime: { nodes: Array<(
      { slug: string, year: number | null, season: AnimeSeason | null, title: { romaji: string }, animethemes: Array<{ type: ThemeType, sequence: number | null, animethemeentries: Array<{ version: number, videos: { nodes: Array<{ tags: string | null }> } }> }>, images: { nodes: Array<{ facet: ImageFacet, link: string }> } }
      & { ' $fragmentRefs'?: { 'AnimeSummaryCardAnimeFragment': AnimeSummaryCardAnimeFragment;'AnimeSummaryCardAnimeExpandableFragment': AnimeSummaryCardAnimeExpandableFragment } }
...
export type SeasonDetailPageSeasonFragment = (
  { season: AnimeSeason, seasonLocalized: string, anime: { data: Array<(
      { slug: string, title: { romaji: string } }
      & { ' $fragmentRefs'?: { 'AnimeSummaryCardAnimeFragment': AnimeSummaryCardAnimeFragment;'AnimeSummaryCardAnimeExpandableFragment': AnimeSummaryCardAnimeExpandableFragment } }
    )> } | null }
...
export const SearchAnimeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchAnime"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"query"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"titleRomaji_like"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"season"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeSeason"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"year"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"format"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeFormat"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeSort"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"animePagination"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"query"}}},{"kind":"Argument","name":{"kind":"Name","value":"titleRomaji_like"},"value":{"kind":"Variable","name":{"kind":"Name","value":"titleRomaji_like"}}},{"kind":"Argument","name":{"kind":"Name","value":"season"},"value":{"kind":"Variable","name":{"kind":"Name","value":"season"}}},{"kind":"Argument","name":{"kind":"Name","value":"year"},"value":{"kind":"Variable","name":{"kind":"Name","value":"year"}}},{"kind":"Argument","name":{"kind":"Name","value":"format"},"value":{"kind":"Variable","name":{"kind":"Name","value":"format"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"15"}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AnimeSummaryCardAnime"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"AnimeSummaryCardAnimeExpandable"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}},{"kind":"Field","name":{"kind":"Name","value":"paginatorInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasMorePages"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"extractImagesImage"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Image"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"link"}},{"kind":"Field","name":{"kind":"Name","value":"facet"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"createVideoSlugTheme"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeTheme"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"sequence"}},{"kind":"Field","name":{"kind":"Name","value":"group"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"createVideoSlugEntry"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeThemeEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"version"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EpisodeTagEntry"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeThemeEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"episodes"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ContentWarningTagsEntry"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeThemeEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spoiler"}},{"kind":"Field","name":{"kind":"Name","value":"nsfw"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"createVideoSlugVideo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Video"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tags"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"VideoTagsVideo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Video"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"nc"}},{"kind":"Field","name":{"kind":"Name","value":"subbed"}},{"kind":"Field","name":{"kind":"Name","value":"lyrics"}},{"kind":"Field","name":{"kind":"Name","value":"uncen"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"overlap"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"SongTitleSong"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Song"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"romaji"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ThemeTableTheme"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AnimeTheme"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"createVideoSlugTheme"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"sequence"}},{"kind":"Field","name":{"kind":"Name","value":"anime"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}},{"kind":"Field","name":{"kind":"Name","value":"animethemeentries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"createVideoSlugEntry"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"EpisodeTagEntry"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ContentWarningTagsEntry"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"videos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"createVideoSlugVideo"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"VideoTagsVideo"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"song"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"SongTitleSong"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AnimeSummaryCardAnime"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Anime"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"romaji"}}]}},{"kind":"Field","name":{"kind":"Name","value":"year"}},{"kind":"Field","name":{"kind":"Name","value":"season"}},{"kind":"Field","name":{"kind":"Name","value":"seasonLocalized"}},{"kind":"Field","name":{"kind":"Name","value":"formatLocalized"}},{"kind":"Field","name":{"kind":"Name","value":"animethemes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"group"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"images"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"extractImagesImage"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AnimeSummaryCardAnimeExpandable"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Anime"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"animethemes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ThemeTableTheme"}},{"kind":"Field","name":{"kind":"Name","value":"group"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}}]}}]} as unknown as DocumentNode<SearchAnimeQuery, SearchAnimeQueryVariables>;
export const SearchArtistDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchArtist"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"query"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"nameMain_like"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ArtistSort"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artistPagination"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"query"}}},{"kind":"Argument","name":{"kind":"Name","value":"nameMain_like"},"value":{"kind":"Variable","name":{"kind":"Name","value":"nameMain_like"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"15"}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ArtistSummaryCardArtist"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}},{"kind":"Field","name":{"kind":"Name","value":"paginatorInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasMorePages"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"extractImagesImage"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Image"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"link"}},{"kind":"Field","name":{"kind":"Name","value":"facet"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ArtistSummaryCardArtist"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Artist"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"name"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"main"}}]}},{"kind":"Field","name":{"kind":"Name","value":"images"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"extractImagesImage"}}]}}]}}]}}]} as unknown as DocumentNode<SearchArtistQuery, SearchArtistQueryVariables>;
...
export const SearchSeriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchSeries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"query"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"titleRomaji_like"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sort"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SeriesSort"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"seriesPagination"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"query"}}},{"kind":"Argument","name":{"kind":"Name","value":"titleRomaji_like"},"value":{"kind":"Variable","name":{"kind":"Name","value":"titleRomaji_like"}}},{"kind":"Argument","name":{"kind":"Name","value":"sort"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sort"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"15"}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"romaji"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"paginatorInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasMorePages"}}]}}]}}]}}]} as unknown as DocumentNode<SearchSeriesQuery, SearchSeriesQueryVariables>;
