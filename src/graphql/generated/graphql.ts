...
export type ArtistDetailPageArtistFragment = (
  { slug: string, name: { main: string, native: string | null }, synonyms: Array<{ text: string }>, performances: Array<{ alias: string | null, as: string | null, song: { id: number, title: { romaji: string | null }, performances: Array<{ alias: string | null, as: string | null, memberAlias: string | null, memberAs: string | null, artist: { slug: string, name: { main: string } } }>, animethemes: Array<(
