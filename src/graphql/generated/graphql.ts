...
export type Liked = AnimeThemeEntry | Playlist;
...
export type ThemeDetailCardThemeFragment = (
  { type: ThemeType, sequence: number | null, group: { name: string, slug: string } | null, anime: (
    ...
    { version: number | null, videos: { nodes: Array<(
...
export type HomePageFeaturedThemeFragment = { animethemeentry: { ' $fragmentRefs'?: { 'FeaturedThemeEntryFragment': FeaturedThemeEntryFragment } }, video: { ' $fragmentRefs'?: { 'FeaturedThemeVideoFragment': FeaturedThemeVideoFragment } } } & { ' $fragmentName'?: 'HomePageFeaturedThemeFragment' };
